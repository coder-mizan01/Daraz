...
const Header = () => {
 ...
 <div className="responsive-menu">
  <GiHamburgerMenu style={{color:'#F85606',fontSize:'1.8rem'}} type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions" />
<div className="offcanvas offcanvas-start" style={{width:'350px'}} data-bs-scroll="true" tabIndex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
  <div className="offcanvas-header">
    <img src={DarazLogo} alt="darazlogo" style={{width : '150px',height : 'auto'}} className="offcanvas-title" id="offcanvasWithBothOptionsLabel" />
